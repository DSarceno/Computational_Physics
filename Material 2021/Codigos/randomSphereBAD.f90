...
!    gfortran -Wall -pedantic -std=f95 -c -o randomSphereBAD.o randomSphereBAD.f90
!    gfortran -Wall -pedantic -std=f95 -o randomSphereBAD.x types.o randomSphereBAD.o
