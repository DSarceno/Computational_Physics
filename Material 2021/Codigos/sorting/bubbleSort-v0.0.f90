...
!    ordenar numeros enteros de modo ascendente.  Para una version con mas
!    informacion de salida ver bubbleSort-v0.1.f90.  Para ver la version
...
!    gfortran -Wall -pedantic -std=f95 -c -o bubbleSort-v0.0.o bubbleSort-v0.0.f90
!    gfortran -o bubbleSort-v0.0.x bubbleSort-v0.0.o 
