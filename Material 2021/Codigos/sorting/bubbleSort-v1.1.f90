...
!    version con menos informacion de salida ver bubbleSort-v1.0.f90.  Para
!    ver la version sin la optimizacion ver bubbleSort-v0.*.f90

!    Codificación del texto: UTF8
!    Compiladores probados: GNU Fortran (SUSE Linux) 7.3.1, GNU Fortran
!    (Debian 4.7.2-5) 4.7.2
!    Instrucciones de compilación: no requiere nada mas
!    gfortran -Wall -pedantic -std=f95 -c -o bubbleSort-v1.1.o bubbleSort-v1.1.f90
!    gfortran -o bubbleSort-v1.1.x bubbleSort-v1.1.o 
